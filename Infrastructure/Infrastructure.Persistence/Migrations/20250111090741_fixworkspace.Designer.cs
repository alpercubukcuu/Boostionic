...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250111090741_fixworkspace")]
    partial class fixworkspace
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Domain.Entities.OwnerEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Core.Domain.Entities.UserRegisterCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Core.Domain.Entities.Workspace", b =>
                {
                    ...
                    b.Property<bool>("IWorkflows")
                        .HasColumnType("bit");

                    b.Property<bool>("IsEnable")
                        .HasColumnType("bit");

                    b.Property<bool>("IsGrowth")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Core.Domain.Entities.BusinessPlace", b =>
                {
                    b.HasOne("Core.Domain.Entities.OwnerEntity", "OwnerEntity")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Domain.Entities.FileEntity", b =>
                {
                    b.HasOne("Core.Domain.Entities.OwnerEntity", "Owner")
                        .WithMany()
