...
{
    public class
        GetAllBusinessPlaceHandler : IRequestHandler<GetAllBusinessPlaceQuery, IResultDataDto<List<BusinessPlaceDto>>>
    {
        ...
        public async Task<IResultDataDto<List<BusinessPlaceDto>>> Handle(GetAllBusinessPlaceQuery request,
