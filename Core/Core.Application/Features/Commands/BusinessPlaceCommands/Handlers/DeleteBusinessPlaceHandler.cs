...
{
    public class DeleteBusinessPlaceHandler : BaseCommandHandler,
        IRequestHandler<DeleteBusinessPlaceCommand, IResultDataDto<bool>>
    {
        ...
        public DeleteBusinessPlaceHandler(IMapper mapper, IBusinessPlaceRepository businessPlaceRepository,
        ...
        public async Task<IResultDataDto<bool>> Handle(DeleteBusinessPlaceCommand request,
            CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                await AddUserLog("BusinessPlace Delete Handler", "BusinessPlace", getData.Id, TransactionEnum.Delete,
                    getData.UserId);
            }
